package com.github.yooryan.outbound.httpclient4;
...
public class HttpOutboundHandler implements OutboundHandler{
    ...
    private HttpOutboundHandler(Builder builder){
    ...
    public static class Builder {
        ...
        public HttpOutboundHandler build(){
            ...
            return new HttpOutboundHandler(this);
        }
